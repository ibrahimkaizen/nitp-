 ...
 */
?><!DOCTYPE html>
<html<?php if(isset($html_attributes)):?><?php print $html_attributes;?><?php endif;?><?php print $rdf_namespaces;?>>
<head>
...
<body<?php if(isset($body_attributes)):?><?php print $body_attributes; ?><?php endif;?>>
  <div id="skip-link">
